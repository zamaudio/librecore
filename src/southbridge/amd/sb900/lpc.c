...
static void sb900_lpc_read_resources(device_t dev)
{
	struct resource *res;
...
static void sb900_lpc_set_resources(struct device *dev)
{
	struct resource *res;
 ...
 *
 */
static void sb900_lpc_enable_childrens_resources(device_t dev)
{
	struct bus *link;
	u32 reg, reg_x;
	int var_num = 0;
...
static void sb900_lpc_enable_resources(device_t dev)
{
	pci_dev_enable_resources(dev);
	sb900_lpc_enable_childrens_resources(dev);
}
...
static struct device_operations lpc_ops = {
	.read_resources = sb900_lpc_read_resources,
	.set_resources = sb900_lpc_set_resources,
	.enable_resources = sb900_lpc_enable_resources,
